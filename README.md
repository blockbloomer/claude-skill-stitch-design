...
This skill requires a **Stitch MCP Server** connection in Claude Code. Configure it in your Claude Code MCP settings to enable the following tools:

需要在 Claude Code 中配置 **Stitch MCP Server** 连接，启用以下工具：
